...
if __name__ == "__main__":
    ...
    if result.get("total_products") == 3:
        ...
        print(
            f"❌ Test 1a FAILED: Expected total_products=3, got {result.get('total_products')}"
        )
    ...
    if result.get("total_value") == expected_value:
        ...
        print(
            f"❌ Test 1b FAILED: Expected total_value={expected_value}, got {result.get('total_value')}"
        )
    ...
    if result.get("in_stock_count") == 2:
        ...
        print(
            f"❌ Test 1c FAILED: Expected in_stock_count=2, got {result.get('in_stock_count')}"
        )
    ...
    if result.get("categories") == {"Fruit", "Electronics"}:
        ...
        print(
            f"❌ Test 1d FAILED: Expected {{'Fruit', 'Electronics'}}, got {result.get('categories')}"
        )
    ...
    if result.get("total_value") == 25.00 and result.get("in_stock_count") == 2:
        ...
        print(
            f"   Got: total_value={result.get('total_value')}, in_stock_count={result.get('in_stock_count')}"
        )
